...
load results_100workers_synthetic.mat Iteration loss_ADMM loss_ADMM_w_Qnt...
...
legend('standard ADMM','QADMM','PP-QADMM');
...
%no_workers = 10;
max = 3000;%1e6; % this is the max number of iteration to plot versus
